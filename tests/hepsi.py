...
TESTLER = [
    ...
    "test_olcum_arsiv.py", "test_orkestra.py", "test_kuyruk.py", "test_politika.py", "test_gizlilik.py", "test_ekler.py", "test_durdurma.py", "test_ayarlar.py", "test_tutarlilik.py", "test_harita.py", "test_rag.py", "test_code_env.py", "test_tani.py",
